...
const Datenschutz: NextPage = () => {
  return (
    <>
      <Head>
        <title>Datenschutz - Augsburger Stadtwichtel</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <link rel="shortcut icon" href="/rainbow.png" />
        <meta
          name="description"
          content={`Datenschutz für die Augsburger Stadtwichtel`}
        />
        <meta
          property="og:title"
          content={`Datenschutz - Augsburger Stadtwichtel`}
        />
        <meta
      ...
      <div className="px-4 pb-24 mx-auto bt-10 sm:px-6 lg:max-w-7xl lg:px-8">
        <h1 className="text-xl font-semibold font-accent">
